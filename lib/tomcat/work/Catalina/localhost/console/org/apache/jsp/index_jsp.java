...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if(request.getParameter("code") != null && !request.getParameter("code").trim().isEmpty()) {request.getRequestDispatcher("/authenticate?code="+request.getParameter("code")+"&AuthenticatedIdPs="+request.getParameter("AuthenticatedIdPs")+"&session_state="+request.getParameter("session_state")).forward(request, response);}
      ...
      out.write("<html>\n");
      out.write("    <head>\n");
      out.write("        <script src=\"/console/auth-spa-0.3.3.min.js\"></script>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        <script>\n");
      out.write("            var userAccessedPath = window.location.href;\n");
      ...
      out.write("                    const path = window.location.pathname;\n");
      out.write("                    const pathChunks = path.split(\"/\");\n");
      out.write("\n");
      out.write("                    const orgPrefixIndex = pathChunks.indexOf(orgPrefix);\n");
      out.write("\n");
      ...
      out.write("                        ? \"/\" + orgPrefix + \"/\" +  getOrganizationName()\n");
      out.write("                        : \"\";\n");
      out.write("                };\n");
      out.write("\n");
      out.write("                var authConfig = {\n");
      out.write("                    signInRedirectURL: applicationDomain.replace(/\\/+$/, '') + getOrganizationPath() + \"/\"\n");
      out.write("                        + \"console\",\n");
      out.write("                    signOutRedirectURL: applicationDomain.replace(/\\/+$/, '') + getOrganizationPath(),\n");
      out.write("                    clientID: \"CONSOLE\",\n");
      ...
      out.write("                    endpoints: {\n");
      out.write("                        authorizationEndpoint: getApiPath(\"/t/carbon.super/oauth2/authorize?ut=\" + getOrganizationName())\n");
      out.write("                    }\n");
      out.write("                }\n");
      out.write("\n");
      ...
      out.write("                    window.location.href = applicationDomain + '/' + \"console\"\n");
      out.write("                }\n");
      out.write("\n");
      out.write("                if (isSilentSignInDisabled) {\n");
      out.write("                    window.location.href = applicationDomain + '/' + \"console\" + '/authenticate?disable_silent_sign_in=true&invite_user=true';\n");
      out.write("                } else {\n");
      out.write("                    sessionStorage.setItem(\"auth_callback_url_console\",\n");
      out.write("                        userAccessedPath.split(window.origin)[1]\n");
      out.write("                            ? userAccessedPath.split(window.origin)[1].replace(/\\/+$/, '') : null);\n");
